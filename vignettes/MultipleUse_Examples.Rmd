...
```{r, fig.width = 9}
(gg_s2 <- splnr_plot_solution(s2, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r, fig.width = 9}
(gg_s2b <- splnr_plot_solution(s2b, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r, fig.width=9}
(gg_s3 <- splnr_plot_solution(s3, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
(gg_s4 <- splnr_plot_solution(s4, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
(gg_s5 <- splnr_plot_solution(s5, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r, fig.width = 9}
(gg_s6 <- splnr_plot_solution(s6, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(
    PUs = PUs, Bndry = Bndry,
...
(gg_s7 <- splnr_plot_solution(s7, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r, fig.width=9}
 (gg_s10 <- splnr_plot_solution(s10, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
   splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r, fig.width=9}
(gg_s11 <- splnr_plot_solution(s11, zones = TRUE, colorVals = c("#c6dbef", "#3182bd", "black"), legendLabels = c("Not selected", "Zone 1", "Zone 2")) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
