...
target <- splnr_CPA_CSapproach_assignTargets(featuresDF = datEx_species_bin,
                             targetsDF = target,
...
(ggClimDens <- splnr_plot_climKernelDensity_Fancy(solution_list = list(dat_solnClim), names = c("Input 1"), legendTitle = "Climate velocity (add unit)", xAxisLab = "Climate velocity"))
```
