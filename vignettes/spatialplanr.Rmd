...
(splnr_plot_solution(datEx_soln2) +
  splnr_gg_add(PUs = PUs, Bndry = Bndry, lockedInAreas = MPAsCoralSea, colInterest = MPAsCoralSea$wdpa, Type = "Full", colorLI = "lightgrey", alphaLI = 0.2, land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
...
```{r}
(splnr_plot_solution(datEx_soln2) +
  splnr_gg_add(lockedInAreas = MPAsCoralSea, colInterest = MPAsCoralSea$wdpa, Type = "Contours", land = landmass, cropLand = PUs, ggtheme = splnr_theme))
```
