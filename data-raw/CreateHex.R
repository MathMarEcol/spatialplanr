...
Bndry <- dplyr::tibble(x = c(xi1, xi2, xi3, xi4, xi5, xi6),
...
ggplot2::ggplot(data = Bndry) + ggplot2::geom_sf()
...
ggplot2::ggplot() + ggplot2::geom_sf(data = landmass) + ggplot2::geom_sf(data = Bndry, fill = NA)
